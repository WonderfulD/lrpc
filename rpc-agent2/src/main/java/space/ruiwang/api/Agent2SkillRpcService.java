...
@RpcAgentService
public class Agent2SkillRpcService implements AgentSkillService {
    private final Agent2SkillExecutor executor;

    public Agent2SkillRpcService(Agent2SkillExecutor executor) {
